            ...
            switch (selectType) {
                ...
                case "get-level-video": {
                    ...
                    if(skin[0].streamedVideo)
                        config.videoViewerWithSite ? link = `${skin[0].streamedVideo}` : link = skin[0].streamedVideo
                    else
                        config.imageViewerWithSite ? link = `${skin[0].displayIcon}` : link = skin[0].displayIcon
